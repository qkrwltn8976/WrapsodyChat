...
import { HeaderType, MemberListType, RoomType, InfoHeaderType, CIType } from '../../../libs/enum-type';
...
class CreateOrInvite extends React.Component<CIProps>{
                            ...
                            <div className="wrapmsgr_popup manage_doc_room" ng-class="{disabled: !loggedIn}" ng-show="activePopup == 'manage_doc_room'">
                                ...
                                <form name="manageDocRoomForm" ng-submit="submitDocRoom()" className="ng-pristine ng-valid">
                                    <div className="wrapmsgr_popup_body">
                                        <InfoHeader convoType= {this.props.ciType} memberCount = {5} docName = {"dfawe rawerew.txt"}/>
                                        <div className="group">
