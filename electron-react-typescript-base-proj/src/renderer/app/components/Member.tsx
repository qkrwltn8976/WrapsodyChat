...
class Member extends React.Component<MemberInfo>{
    ...
    render(){
        ...
        return(
            <li ng-repeat="member in current.members | memberFilter:search.user:users | orderBy:'userName'" wrapmsgr-user-profile="users[member.userId]" className="ng-scope ng-isolate-scope">
